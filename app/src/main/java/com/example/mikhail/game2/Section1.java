...
public class Section1 extends AppCompatActivity {
    ...
    public static final String T2T_mbd = "mbd1";
    public static final String T2T_mbd_lvl = "lvl1";
    public static final String T2T_mbd_tryc = "tryc1";
    public static final String T2T_mbd_help = "help1";
        ...
        switch (v.getId()){
            ...
            case R.id.b_help:
                if (help > 3){Toast.makeText(this, (DataBase.section1[i]).answer, Toast.LENGTH_SHORT).show();}
                    ...
                    } else {MainActivity.coins -= 100; Toast.makeText(this, (DataBase.section1[i]).answer, Toast.LENGTH_SHORT).show(); help+=1; tryC+=1;view_coins.setText(Integer.toString(MainActivity.coins));}}
                    ...
                    } else { MainActivity.coins -= 10; Toast.makeText(this, (DataBase.section1[i]).help, Toast.LENGTH_SHORT).show(); help+=1; tryC+=1;view_coins.setText(Integer.toString(MainActivity.coins));}}
